        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link href="/admin/login" className="text-muted-foreground hover:text-primary">Admin Login</Link></li>
              <li><Link href="/editor/login" className="text-muted-foreground hover:text-primary">Editor Login</Link></li>
