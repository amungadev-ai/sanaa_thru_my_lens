...
import { EditorCalendarPostDialog } from "./EditorCalendarPostDialog";
...
export function EditorCalendarGrid({ posts, year, month }: EditorCalendarGridProps) {
  ...
  return (
    <>
      ...
      {selectedPost && (
        <EditorCalendarPostDialog post={selectedPost} onClose={() => setSelectedPost(null)} />
      )}

      {dialogDate && (
        <EditorCalendarPostDialog date={dialogDate} onClose={() => setDialogDate(null)} />
      )}
    </>
  );
}
